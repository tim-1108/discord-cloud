...
// TODO: implement a message attachment link cache
...
export async function getBulkMessageAttachments(messages: string[], channel: string): Promise<Map<string, string | null> | null> {
    ...
    // CRITICAL: Do not use Array.sort, this will mutate any array the callee may pass into here!
...
function extractAttachment(message: Message) {
